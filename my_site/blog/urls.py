...
urlpatterns = [
    ...
    path("add_tag/<int:post_pk>/", views.add_tag_from_post_view, name="add-tag-post"),
    path("logout/",views.logout_view, name="user-logout"),
    path("post/<int:post_pk> <int:comment_pk>/delete", views.delete_comment, name="delete-comment"),
