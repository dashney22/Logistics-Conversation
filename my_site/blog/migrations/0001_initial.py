    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('mr', 'Mr.'), ('mrs', 'Mrs.'), ('ms', 'Ms.'), ('dr', 'Dr.'), ('prof', 'Prof.')], default='mr', max_length=6)),
                ('position', models.CharField(max_length=100)),
                ('profile_picture', models.ImageField(upload_to='posts/profile_pictures')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commentor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='commentors', to=settings.AUTH_USER_MODEL)),
